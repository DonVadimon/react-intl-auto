//! Core CLI logic shared between binary and JS bindings
//!
//! This module contains the main extraction logic that can be called
//! from both the CLI binary and the napi-rs JS bindings.
...
/// This is the main entry point that can be called from both binary and JS
...
/// Run extraction in perfile mode (streaming)
fn run_perfile_mode(
